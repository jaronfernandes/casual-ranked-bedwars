...
class Help(commands.Cog):
    ...
    def create_help_embed(self, ctx):
        ...
        help_embed.add_field(name="stats", value="Get your current or another user's season statistics", inline=False)
        help_embed.add_field(name="season", value="View the statistics for the current or a past season", inline=False)
